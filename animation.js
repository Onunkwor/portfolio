...
// define coner that is open
let activeCorner = "";

// add an even listner to the resize events
window.addEventListener("resize", handelWindowResize);

// function that handels the stylin when resizing window
  ...
  switch (activeCorner) {
    ...
    case "bottom-left":
      if (window.innerWidth <= 600) {
        ...
        blActive = "translateX(10vw) translateY(-12vh)";
        blContent.style.transform = "translateX(10vw) translateY(-12vh)";
...
function playAnimation(animation, reverseAnimation) {
  //remove all the animation classes from image
  heroImage.className = "";
